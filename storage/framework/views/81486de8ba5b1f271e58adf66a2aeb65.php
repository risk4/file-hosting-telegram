<div class="max-w-3xl mx-auto px-4 sm:px-6 py-10">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-400 font-mono text-sm">
            Maks <?php echo e(\App\Models\Setting::get('max_upload_mb', 2048)); ?>MB per file
        </p>
    </div>
    ...
    <div class="flex gap-2 mb-6 bg-gray-900 border border-gray-800 rounded-xl p-1 w-fit">
        <button wire:click="$set('activeTab', 'file')"
                class="px-5 py-2 text-sm font-medium rounded-lg transition-all
                       <?php echo e($activeTab === 'file' ? 'bg-teal-500/15 text-teal-400' : 'text-gray-400 hover:text-white'); ?>">
            📁 File
        </button>
        <button wire:click="$set('activeTab', 'note')"
                class="px-5 py-2 text-sm font-medium rounded-lg transition-all
                       <?php echo e($activeTab === 'note' ? 'bg-teal-500/15 text-teal-400' : 'text-gray-400 hover:text-white'); ?>">
            📝 Catatan
        </button>
    </div>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($uploadResults) > 0): ?>
    <div class="mb-6 space-y-2">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $uploadResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div x-data="{ copied: false }"
             class="flex flex-col gap-3 px-4 py-3 rounded-xl border text-sm
                    <?php echo e($result['status'] === 'success' ? 'bg-teal-500/5 border-teal-500/30 text-teal-300' : 'bg-red-500/5 border-red-500/30 text-red-300'); ?>">
            <div class="flex items-center gap-3">
                <span><?php echo e($result['status'] === 'success' ? '✅' : '❌'); ?></span>
                <span class="font-mono"><?php echo e($result['name']); ?></span>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($result['message'])): ?>
                    <span class="text-xs opacity-70">— <?php echo e($result['message']); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($result['status'] === 'success' && isset($result['url'])): ?>
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                <a href="<?php echo e($result['url']); ?>" target="_blank" rel="noopener noreferrer"
                   class="truncate text-xs text-teal-200 hover:text-teal-100 font-mono">
                    <?php echo e($result['url']); ?>

                </a>
                <button type="button"
                        x-on:click="navigator.clipboard.writeText('<?php echo e($result['url']); ?>').then(() => { copied = true; setTimeout(() => copied = false, 2000) })"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'file'): ?>
    <div class="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-5">
        ...
        <div x-data="{ dragging: false }"
            ...
            <p class="text-sm text-gray-500 font-mono">Hingga <?php echo e(\App\Models\Setting::get('max_upload_mb', 2048)); ?>MB per file</p>
        </div>
        ...
        <div class="space-y-2">
            ...
            <div class="flex items-center gap-3 bg-gray-800 rounded-lg px-3 py-2 text-sm">
                ...
                <span class="flex-1 font-mono text-xs truncate"><?php echo e($file->getClientOriginalName()); ?></span>
                <span class="text-xs text-gray-500 font-mono"><?php echo e(round($file->getSize() / 1048576, 1)); ?> MB</span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-400 text-xs font-mono"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'note'): ?>
    <div class="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-5">
        <div>
...
<?php /**PATH C:\laragon\www\telestore-laravel\resources\views/livewire/public/file-upload.blade.php ENDPATH**/ ?>